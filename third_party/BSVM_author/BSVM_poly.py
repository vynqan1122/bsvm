# -*- coding: utf-8 -*-
"""
Verbose-traceable BSVM with Polynomial Kernel - Manuscript Figure Generator (Zipped PDFs)
Now includes:
 • Uses Polynomial Kernel and adds '_poly' suffix to saved filenames.
...
def plot_decision_boundary(model, X, y, filename_base, h=None, yh=None, attempt_coord=None, attempt_label=None, mis_idx=None):
    ...
    # Save the figure as PDF with the '_poly' suffix
    filename = f"{filename_base}_{FIG_COUNT:02d}_poly.pdf"
...
def main():
    ...
    try:
        ...
        # --- CHANGED: Updated kernel to 'poly' ---
        parameters = dict(C=10, kernel='poly', degree=3, class_weight=class_weights)
